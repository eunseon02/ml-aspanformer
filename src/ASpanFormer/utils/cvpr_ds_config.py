...
_CN.COARSE.D_FLOW= 128
_CN.COARSE.LAYER_NUM =  4
_CN.COARSE.NSAMPLE = [2,8]
_CN.COARSE.RADIUS_SCALE= 5
_CN.COARSE.COARSEST_LEVEL= [26,26]
_CN.COARSE.TRAIN_RES = None
_CN.COARSE.TEST_RES = None
